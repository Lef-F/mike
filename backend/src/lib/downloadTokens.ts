...
/**
 * Public accessor used by other modules (e.g. MCP OAuth state signing) that
 * need to derive HMAC signatures from the same secret. Throws if the secret
 * isn't configured — same as signDownload/verifyDownload.
 */
